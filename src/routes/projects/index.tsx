...
import { PROJECT_CATEGORIES, type ProjectCategory, type APIProject } from "@/data/projects";
import { useProjectsStore, fetchProjectById } from "@/stores/useProjectsStore";
