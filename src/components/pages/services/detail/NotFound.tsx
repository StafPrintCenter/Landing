    ...
    <SiteShell>
      <div className="container-x flex min-h-[65vh] flex-col items-center justify-center py-16 text-center">
        ...
        <p className="mt-3 max-w-md text-muted-foreground leading-relaxed">
          Le service que vous recherchez n'existe pas, a changé d'adresse
          ou n'est plus proposé dans notre catalogue actuel.
        </p>
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-3">
          ...
          >
            <ArrowLeft size={16} /> Parcourir les services
          </Link>
          <a
