...
export function ServiceDetailError({ error, reset }: ServiceErrorProps) {
  return (
    <SiteShell>
      <div className="container-x flex min-h-[65vh] flex-col items-center justify-center py-16 text-center">
        ...
        <p className="mt-3 max-w-md text-muted-foreground leading-relaxed">
          Une erreur s'est produite lors de la récupération des détails de ce service.
          Vous pouvez réessayer ou retourner au catalogue.
        </p>
