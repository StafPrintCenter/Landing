...
export function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[oklch(0.7_0.17_150)] text-white shadow-xl ring-4 ring-[oklch(0.7_0.17_150/25%)] transition hover:scale-105"
    >
